...
<body class="img js-fullheight" style="background-image: url(images/WDS.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Fom Registrasi Aplikasi Pengaduan Masyarakat Desa Windusengkahan</h2>
				</div>
			</div>
			<div class="row justify-content-center">
