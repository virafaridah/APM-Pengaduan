...
<head>
	<title>APM Windusengkahan</title>
	<meta charset="utf-8">
...
<body class="img js-fullheight" style="background-image: url(/images/Kelurahan.png);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Selamat datang Di Aplikasi Pengaduan Masyarakat Desa Windusengkahan</h2>
				</div>
			</div>
			<div class="row justify-content-center">
